    ...
    <div className={`relative aspect-square w-full max-w-[420px] sm:max-w-[460px] select-none ${className}`}>
      ...
      <div className="relative w-full h-full rounded-full p-[6px] sm:p-[7px] bg-gradient-to-tr from-[#FFDF79] via-[#8C6D1F] to-[#FFEAA7] shadow-[0_0_50px_rgba(234,179,8,0.4),_0_20px_50px_rgba(0,0,0,0.95)]">
        ...
        <div className="w-full h-full rounded-full p-[3px] bg-[#070A11] relative overflow-hidden">
          ...
          <div className="absolute top-7 right-7 sm:top-9 sm:right-9 z-20 flex flex-col items-center pointer-events-none">
            {/* Crown */}
          ...
          <div className="absolute inset-x-0 bottom-0 z-20 pb-4 sm:pb-5 px-3 sm:px-5 flex flex-col items-center text-center pointer-events-none">
